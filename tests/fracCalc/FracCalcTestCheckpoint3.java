...
@RunWith(Suite.class)
@Suite.SuiteClasses({
    FracCalcTestCheckpoint3Addition.class,
    FracCalcTestCheckpoint3Subtraction.class,
    FracCalcTestCheckpoint3Multiplication.class,
    FracCalcTestCheckpoint3Division.class,
})
